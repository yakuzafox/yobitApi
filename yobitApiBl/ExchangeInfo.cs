...
namespace yobitApiBl
{
    ...
    public enum FilterType { IcebergParts, LotSize, MarketLotSize, MaxNumAlgoOrders, MaxNumOrders, MaxPosition, MinNotional, PercentPrice, PriceFilter };

    public enum OrderType { Limit, LimitMaker, Market, StopLossLimit, TakeProfitLimit };

    public enum Permission { Leveraged, Margin, Spot };

    public enum QuoteAsset { Aud, Bidr, Bkrw, Bnb, Btc, Busd, Dai, Eth, Eur, Gbp, Idrt, Ngn, Pax, Rub, Trx, Try, Tusd, Uah, Usdc, Usds, Usdt, Xrp, Zar };
